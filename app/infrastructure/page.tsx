      ...
      <section className={gridWrap}>
        ...
        <Container className="relative">
          ...
          >
            ...
            {/* subtle divider */}
            <div className="mx-auto mt-10 h-px max-w-xl bg-gradient-to-r from-transparent via-slate-900/10 to-transparent dark:via-white/10" />
          </motion.div>
        </Container>
      </section>
              ...
              return (
                ...
                >
                  <Card
                    variant="glass"
                    className={[
                      "group h-full min-h-[230px] gap-0 text-center transition-colors",
                      "border-border bg-card/70 hover:bg-card hover:border-blue-500/25",
                      "dark:border-white/10 dark:bg-white/[0.03] dark:hover:bg-white/[0.05] dark:hover:border-blue-400/30",
                    ].join(" ")}
                  >
                    <div className="flex h-full flex-col items-center">
                      <div className="w-full">
                        ...
                        <div className="mt-6">
                          ...
                          <div className="mt-2 min-h-[18px] text-sm text-muted-foreground">
                            {sub || "\u00A0"}
                          </div>
                        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <Card
                  ...
                  variant="glass"
                  className={[
                    "text-center py-4 transition-colors",
                    "border-border bg-card/70 hover:bg-card hover:border-blue-500/25",
                    "dark:border-white/10 dark:bg-white/[0.03] dark:hover:border-blue-400/30",
                  ].join(" ")}
                >
                  <div className="inline-flex items-center justify-center gap-2 text-sm font-semibold text-blue-700 dark:text-blue-300">
